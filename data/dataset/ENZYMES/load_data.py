...
"""load_data.py: file for loading ENZYMES dataset.
Adapted from Jo, J. & al (2022) and
...
data_graph_indicator = np.loadtxt("ENZYMES_graph_indicator.txt", delimiter=",").astype(
    int
)
