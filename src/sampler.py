...
from src.utils.logger import Logger, set_log, start_log, train_log, sample_log, check_log
...
from src.utils.plot import save_graph_list, plot_graphs_list
...
class Sampler(object):
    ...
    def sample(self) -> None:
        ...
        self.train_graph_list, self.test_graph_list = load_data(
            self.configt, get_graph_list=True
        )
